...
def speak_edge(text: str):
    ...
    # Pre-processing: Strip english characters because the el-GR voice fails to parse them natively.
    # Also clean up markdown tokens that might leak from the LLM.
