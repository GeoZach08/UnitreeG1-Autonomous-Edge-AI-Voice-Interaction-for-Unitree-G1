...
# Bilingual Support: Rule 7 dynamically handles mixed-language queries and forces correct TTS language selection
SYSTEM_PROMPT = (
    ...
    "7. ΠΡΟΣΑΡΜΟΓΗ ΓΛΩΣΣΑΣ: Αν η κύρια γλώσσα της ερώτησης είναι τα Αγγλικά (ακόμα και αν η ερώτηση "
    "περιέχει τη λέξη 'μπάμπης' ή αγγλικές λέξεις γραμμένες φωνητικά με ελληνικά γράμματα όπως 'γουάτ ιζ'), "
    "πρέπει να απαντήσεις ΑΥΣΤΗΡΑ στα Αγγλικά. Απάντησε στα Ελληνικά ΜΟΝΟ αν το νόημα και "
    "ολόκληρη η ερώτηση είναι ξεκάθαρα στα Ελληνικά."
)